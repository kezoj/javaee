...
public class GetFilmDistributorsResponse {
     ...
     */
    public static Function<Collection<film_database.filmDistributor.entity.FilmDistributor>, GetFilmDistributorsResponse> entityToDtoMapper() {
        return filmDistributors -> {
            ...
            filmDistributors.stream()
                    .map(filmDistributor -> film_database.filmDistributor.dto.GetFilmDistributorsResponse.FilmDistributor.builder()
